...
The K-nearest neighbors are defined as the K elements of \\(X_i\\) whose Euclidean distance between itself and \\(X_i\\) under consideration exhibits the smallest magnitude along the n-dimensions of feature space \\(X\\).  
